...
if($stats==1){
                                             ?>
                                                ...
                                                <span style="color: red">Not Approved</span>
                                                 <?php } if($stats==0)  { ?>
 <span style="color: brown">Pending Approval</span>
 <?php } ?>
       ...
       <div>
         <footer class="foot">
            <center><p> <b>This system was designed by:</b> JuniorDATAsoft private software development organisation &copy; 2023 All Rights Reserved. </p></center>
        </footer>
                                                 </div>
    </body>
</html>
